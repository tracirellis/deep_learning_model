...
having some technical difficulties. going to try and use original repo again
 

I started this in Python. then wanted to try it in google collab. there is an issue with seeing the h5 files even after ensuring it was installed correctly in my terminal. I was able to verify the data works as it there were no errors in python or google collab. but everything moves too fast. 
